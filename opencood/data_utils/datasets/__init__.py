...
from opencood.data_utils.datasets.ermvp_intermediate_fusion_dataset import Ermvp_IntermediateFusionDataset
...
__all__ = {
    ...
    'Ermvp_IntermediateFusionDataset': Ermvp_IntermediateFusionDataset
}
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    assert dataset_name in ['LateFusionDataset', 'EarlyFusionDataset',
                            ...
                            'Ermvp_IntermediateFusionDataset'], error_message
...
def ermvp_build_dataset(dataset_cfg, visualize=False, train=True, isSim=False):
    dataset_name = dataset_cfg['fusion']['core_method']
    error_message = f"{dataset_name} is not found. " \
                    f"Please add your processor file's name in opencood/" \
                    f"data_utils/datasets/init.py"
    assert dataset_name in ['LateFusionDataset', 'EarlyFusionDataset', 'Ermvp_IntermediateFusionDataset',
